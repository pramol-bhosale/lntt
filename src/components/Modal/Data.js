...
export const savePopupData = {
    header: 'Creating New Record',
    body: <>You are currently in the process of creating a new record. Please take a moment to review the details before saving. You can also update the record later if needed.
    </>,
    outCome:{
        success:{
            header:'',
...
export const modalMap = [
    ...
    { code: SAVE_RECORD_POPUP_CODE, data: savePopupData}
]
