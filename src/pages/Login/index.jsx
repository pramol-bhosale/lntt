        ...
        <div className="col-8 row g-0 login-child-container rounded-3 py-2 px-4 ">
          ...
          <div className="col-12 row g-0 justify-content-center mt-4">
            <div className="col-8 form-floating mt-3">
              <input type="text" className={`form-control ${errors.email ? 'error-login-border' : null}`} id="login-username" placeholder='Username' />
            ...
            <div className="col-8 form-floating mt-3">
              <input type="Password" className={`form-control ${errors.password ? 'error-login-border' : null}`} id="login-password" placeholder='Password' />
